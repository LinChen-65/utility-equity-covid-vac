# python vaccination_adaptive_singledemo_hesitancy_by_income.py MSA_NAME VACCINATION_TIME VACCINATION_RATIO ACCEPTANCE_SCENARIO quick_test
# python vaccination_adaptive_singledemo_hesitancy_by_income.py Atlanta 31 0.1 real False
...
ACCEPTANCE_SCENARIO = sys.argv[4]
...
def assign_acceptance(income, acceptance_scenario): # vaccine_acceptance = 1 - vaccine_hesitancy
...
# Retriev vaccine acceptance as ndarray
...
if(os.path.exists(os.path.join(root,MSA_NAME,
                               ...
                               'history_D2_jue_ew_flood_adaptive_%sd_%s_%s_%sseeds_acceptance_%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO,MSA_NAME)))):
    ...
    if(quick_test=='True'):
        ...
        for policy in policy_list:
            policy = policy.lower()
            if(policy=='baseline'):
                np.array(history_D2_baseline).tofile(os.path.join(root,MSA_NAME,'vaccination_results_adaptive_%sd_%s_0.01','history_D2_baseline_adaptive_%sd_%s_%s_%sseeds_acceptance_%s_%s')
                                                                  %(VACCINATION_TIME_STR,VACCINATION_RATIO,VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,ACCEPTANCE_SCENARIO,MSA_NAME))
