...
#policy_list = ['SVI_new']
#policy_list = ['Minority']
policy_list = ['Age', 'Income', 'Occupation']
...
def distribute_and_check(cbg_table, demo_feat, vaccine_acceptance, reverse=False,target_idx=-1): #20220302
        ...
        if(policy == 'Age'):
            ...
            for target_idx in [1,2,3]:
                ...
                if(os.path.exists(filename)):
                    ...
                    vaccination_vector_age = distribute_and_check(cbg_table, demo_feat, vaccine_acceptance, reverse=False, target_idx=target_idx) #20220314 #20220302
        ...
        if(policy == 'Income'):
            ...
            for target_idx in [1,2,3]:
                ...
                if(os.path.exists(filename)):
                    ...
                    vaccination_vector_income = distribute_and_check(cbg_table, demo_feat, vaccine_acceptance, reverse=False, target_idx=target_idx) #20220314 #20220302
        ...
        if(policy == 'Occupation'):
            ...
            for target_idx in [1,2,3]:
                ...
                if(os.path.exists(filename)):
                    ...
                    demo_feat = 'EW_Ratio'
                    vaccination_vector_occupation = distribute_and_check(cbg_table, demo_feat, vaccine_acceptance, reverse=False, target_idx=target_idx) #20220314
        ...
        if(policy == 'Minority'):
            ...
            for target_idx in [1,2,3]:
                ...
                if(os.path.exists(filename)):
                    ...
                    this_start = time.time()
                    vaccination_vector_minority = distribute_and_check(cbg_table, demo_feat, vaccine_acceptance, reverse=False, target_idx=target_idx) #20220302
                    print('Policy constructed. Time: ', time.time()-this_start)
                    final_deaths = run_simulation(starting_seed=STARTING_SEED, num_seeds=NUM_SEEDS, #20220304
