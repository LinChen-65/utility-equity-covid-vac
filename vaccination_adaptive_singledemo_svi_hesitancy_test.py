...
if('Age_Flood' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_age_flood_adaptive_%sd_%s_%s_%sseeds_acceptance%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,ACCEPTANCE_SCENARIO, MSA_NAME)))):
...
if('Income_Flood' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                           'vaccination_results_adaptive_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                           'test_history_D2_income_flood_adaptive_%sd_%s_%s_%sseeds_acceptance%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,ACCEPTANCE_SCENARIO, MSA_NAME)))):
...
if('JUE_EW_Flood' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_jue_ew_flood_adaptive_%sd_%s_%s_%sseeds_acceptance%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,ACCEPTANCE_SCENARIO, MSA_NAME)))):
...
if('SVI' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_svi_adaptive_%sd_%s_%s_%sseeds_acceptance_%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO,MSA_NAME)))):
        print('Results for Age_Flood already exist. No need to simulate again.')   
    else:
        ...
        for policy in policy_list:
            ...
            if(need_to_save_dict[policy]==True):
                if(policy=='baseline'):
                    filename = os.path.join(root,MSA_NAME,
                                            'vaccination_results_adaptive_%sd_%s_0.01' %(VACCINATION_TIME_STR,VACCINATION_RATIO),
                                            'test_history_D2_baseline_%sd_%s_%s_%sseeds_acceptance_%s_%s' %(VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,ACCEPTANCE_SCENARIO,MSA_NAME)
                                            )
                    ...
                    exec('np.array(history_D2_%s).tofile(os.path.join(root,MSA_NAME,\'vaccination_results_adaptive_%sd_%s_0.01\',\'test_history_D2_%s_adaptive_%sd_%s_%s_%sseeds_acceptance_%s_%s\'))' 
        ...
        for policy in policy_list:
            ...
            if(need_to_save_dict[policy]==True):
                if(policy=='baseline'):
                    filename = os.path.join(root,MSA_NAME,
                                            'vaccination_results_adaptive_%sd_%s_0.01' %(VACCINATION_TIME_STR,VACCINATION_RATIO),
                                            'test_history_D2_baseline_adaptive_%sd_%s_%s_%sseeds_%s' %(VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,MSA_NAME)
                                            )
                    np.array(history_D2_baseline).tofile(filename)
                elif(policy =='svi'):
                    filename = os.path.join(root, MSA_NAME, 
                                            'vaccination_results_adaptive_%sd_%s_0.01'%(VACCINATION_TIME_STR,VACCINATION_RATIO),
                                            'test_history_D2_svi_adaptive_%sd_%s_%s_%sseeds_%s'%(VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS,MSA_NAME))
                    np.array(history_D2_svi).tofile(filename)
                else:
                    exec('np.array(history_D2_%s).tofile(os.path.join(root,MSA_NAME,\'vaccination_results_adaptive_%sd_%s_0.01\',\'test_history_D2_%s_adaptive_%sd_%s_%s_%sseeds_acceptance_%s_%s\'))' 
                        % (policy,VACCINATION_TIME_STR,VACCINATION_RATIO,policy,VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO, MSA_NAME))
...
if('Age_Flood_Reverse' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_reverse_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_age_flood_adaptive_reverse_%sd_%s_%s_%sseeds_acceptance_%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO,MSA_NAME)))):
...
if('Income_Flood_Reverse' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_reverse_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_income_flood_adaptive_reverse_%sd_%s_%s_%sseeds_acceptance_%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO,MSA_NAME)))):
...
if('JUE_EW_Flood_Reverse' in policy_list):
    ...
    if(os.path.exists(os.path.join(root,MSA_NAME,
                               'vaccination_results_adaptive_reverse_%sd_%s_0.01'% (VACCINATION_TIME_STR,VACCINATION_RATIO),
                               'test_history_D2_jue_ew_flood_adaptive_reverse_%sd_%s_%s_%sseeds_acceptance_%s_%s' % (VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO,MSA_NAME)))):
...
if(quick_test=='True'):
    ...
    for policy in policy_list:
        ...
        if(need_to_save_dict[policy]==True):
            if(policy!='baseline'):
                exec('np.array(history_D2_%s).tofile(os.path.join(root,MSA_NAME,\'vaccination_results_adaptive_reverse_%sd_%s_0.01\',\'test_history_D2_%s_adaptive_reverse_%sd_%s_%s_%sseeds_acceptance_%s_%s\'))' 
                    % (policy,VACCINATION_TIME_STR,VACCINATION_RATIO,policy,VACCINATION_TIME_STR,VACCINATION_RATIO,RECHECK_INTERVAL,NUM_SEEDS, ACCEPTANCE_SCENARIO, MSA_NAME))
